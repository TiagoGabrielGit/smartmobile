                    ...
                    <div class="card-body">
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            ...
                            $stmt_chamados = $pdo->prepare(
                                "SELECT c.id as id, c.assuntoChamado as assunto, p.nome as atendente, c.relato_inicial, DATE_FORMAT(c.data_abertura, '%d/%m/%Y %H:%i') as data_abertura, s.service as service, ise.item as itemService, c.in_execution as inExecution, cs.status_chamado
                                ...
                                while ($row_chamado = $stmt_chamados->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="flush-heading<?= $row_chamado['id']; ?>">
                                            <button class="accordion-button collapsed <?= $color ?>" id="<?= $color ?>"
                                        ...
                                        <div id="flush-collapse<?php echo $row_chamado['id']; ?>"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <strong>Item:</strong>
                                                <?php echo $row_chamado['itemService'] !== null ? $row_chamado['itemService'] : 'Sem Item'; ?><br>
